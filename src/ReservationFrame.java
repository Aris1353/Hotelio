...
public class ReservationFrame extends JFrame {
	...
	public ReservationFrame(ReservationManager rm) {
		...
		lblmmddyyyy = new JLabel("\u0386\u03C6\u03B9\u03BE\u03B7(mm/dd/yyyy)\r\n");

		lblmmddyyyy_1 = new JLabel("\u0391\u03BD\u03B1\u03C7\u03CE\u03C1\u03B7\u03C3\u03B7(mm/dd/yyyy)");
		...
		Date d1 = new Date();
		d1.setHours(12); d1.setMinutes(30); Long a = d1.getTime();
		
		spinner = new JSpinner();
		spinner.setModel(new SpinnerDateModel(new Date(1401139800000L), new Date(1401138000000L), null, Calendar.DAY_OF_YEAR));
		
		spinner_1 = new JSpinner();
		spinner_1.setModel(new SpinnerDateModel(new Date(1401224400000L), new Date(1401224400000L), null, Calendar.DAY_OF_YEAR));

	...
	class ButtonListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			if(e.getSource() == okButton){
				double nutrition1 = Double.parseDouble(nutritionText1.getText());//Τιμή την ημιδιατροφής
				double nutrition2 = Double.parseDouble(nutritionText2.getText());//Τιμή την πλήρης διατροφής
				NutritionCost nc = new NutritionCost();
				nc.setNutrition1(nutrition1); //Θέτουμε την νέα τιμή
				nc.setNutrition2(nutrition2); //Θετουμε την νέα τιμή
				rm.getDfm().nutritionCostSaveFile(nc); //Αποθήκευση αλλαγών
